...
public class BillsDataAPI {
    private final HashMap<String, WaterBill> waterBillsData;
    private final HashMap<String, ElectricityBill> electricityBillsData;
    private final HashMap<String, GasBill> gasBillsData;
